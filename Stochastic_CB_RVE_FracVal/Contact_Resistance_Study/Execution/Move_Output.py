...
storage_dir = "/state/partition4/Tyler/Conductivity_Study/Strain_Study/Output/"
...
for i in range(len(temp_dirs)):
        ...
        if temp_dirs[i] == perm_dirs[j]:
            ...
            for filename in os.listdir(source_dir + temp_dirs[i]):
                ...
                if temp_type in perm_file_types:
                    ...
                    new_name = storage_dir + perm_dirs[j] + "/" + temp_type + str(perm_file_nums[perm_file_types.index(temp_type)]) + ".csv"
    ...
    if dir_exists is False:
        ...
        for filename in os.listdir(source_dir + temp_dirs[i]):
            ...
            ignore, thickness, DQ, Fill, num = basename.split('_')
            num_int = 0
            temp_name = thickness + "_" + DQ + "_" + Fill + "_" + str(num_int) + ".csv"
